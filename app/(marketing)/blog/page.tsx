...
export const metadata: Metadata = {
  title: "JobMo Blog",
  description: "Career advice, hiring trends, and product updates.",
};
  ...
  return (
    <div className="container py-20">
      <div className="mx-auto max-w-2xl text-center">
        <h1 className="font-display text-4xl font-semibold tracking-tight">JobMo Blog</h1>
        <p className="mt-4 text-muted-foreground">Career advice, hiring trends, and product updates.</p>
