...
export const metadata: Metadata = {
  ...
  description: "Courses, quizzes, and resources to grow your career.",
};
  ...
  return (
    <div className="container py-20">
      <div className="mx-auto max-w-2xl text-center">
        <h1 className="font-display text-4xl font-semibold tracking-tight">Learning Center</h1>
        <p className="mt-4 text-muted-foreground">Courses, quizzes, and resources to grow your career.</p>
