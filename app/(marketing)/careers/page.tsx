...
export const metadata: Metadata = {
  ...
  description: "Help us build the hiring platform Sri Lankas job market deserves.",
};
  ...
  return (
    <div className="container py-20">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-4 text-muted-foreground">Help us build the hiring platform Sri Lankas job market deserves.</p>
